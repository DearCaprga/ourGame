...
class Final_window:
    def __init__(self, screen):
        if ALL_TIMER > 30:
            ...
            write_some(screen, (30, 60), 'Bradley Hand ITC', 30, 'You think to long...', '#92000a')
            write_some(screen, (30, 100), 'Bradley Hand ITC', 30, 'So you are killed', '#92000a')
        elif HEALTH == 0:
            ...
            write_some(screen, (30, 100), 'Bradley Hand ITC', 30, 'You you are lucky', '#92000a')
        write_some(screen, (0, 140), 'Bradley Hand ITC', 30, '-------------------------------------------', '#92000a')
        write_some(screen, (20, 170), 'Bradley Hand ITC', 30, f'You time = {ALL_TIMER}', '#92000a')
        write_some(screen, (20, 200), 'Bradley Hand ITC', 30, f'You finished {COUNT_LEVEL} levels', '#92000a')
        write_some(screen, (20, 230), 'Bradley Hand ITC', 30, f'You health = {HEALTH}', '#92000a')
        write_some(screen, (20, 260), 'Bradley Hand ITC', 30, f'You took {THINGS} things', '#92000a')
